...
let quiz1: {
...
}= await inquirer.prompt([
    {
        ...
        choices: [
            ...
            chalk.bold.yellow("C. Static Typeing"),
            chalk.bold.yellow("D. Asynchronous operation"),
        ],
    }
]);
...
let quiz2: {
...
} =await inquirer.prompt([
    {
        name: "Qno_2",
        type: "list",
        message: chalk.bold.cyan("\Q2.How do you specify that a function does not return anything in TypeScript?\n"),
        choices: [
...
switch(quiz3.Qno_3){
    case chalk.bold.yellow("B. function foo(param?: string)"):
        ...
        default:
            console.log(chalk.bold.red("\nIncorrect Answer"));
            console.log(chalk.bold.yellow("\nCorrect Answer is `B. unction foo (param?: string)`. "));
            break;
        }
        let quiz4: {
            Qno_4: string;
        ...
        }= await inquirer.prompt([
            {
                name: "Qno_4",
                type: "list",
                message: chalk.bold.cyan("\q4. how do you define an array of  strings in TypeScript?\n"),
                choices:[
        ...
        switch (quiz4.Qno_4){
           ...
           switch (quiz5.Qno_5){
            case chalk.bold.yellow("B. A type can be one of several types"):
